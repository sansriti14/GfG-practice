<h2><a href="https://www.geeksforgeeks.org/problems/minimum-spanning-tree/0">Minimum Spanning Tree</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt; font-family: arial, helvetica, sans-serif;"><span style="font-family: arial, helvetica, sans-serif;"><span style="font-size: 14pt;">Given a weighted, undirected, and connected graph of </span></span><strong style="font-family: arial, helvetica, sans-serif; font-size: 14pt;">V</strong><span style="font-family: arial, helvetica, sans-serif;"><span style="font-size: 14pt;"> vertices and </span></span><strong style="font-family: arial, helvetica, sans-serif; font-size: 14pt;">E</strong><span style="font-family: arial, helvetica, sans-serif;"><span style="font-size: 14pt;"> edges. The task is to find the sum of weights of the edges of the Minimum Spanning Tree. Given an</span></span><span style="background-color: #ffffff; color: rgba(0, 0, 0, 0.87);"> adjacency list adj as input parameters. </span><span style="background-color: #ffffff; color: rgba(0, 0, 0, 0.87);"><span style="color: #000000;"><span style="color: rgba(0, 0, 0, 0.87); font-family: arial, helvetica, sans-serif;"><span style="font-size: 14pt;"><span style="color: #000000;">Here adj[i] contains vectors of size 3, where the</span> f</span></span><span style="font-family: arial, helvetica, sans-serif; font-size: 18.6667px;">irst two denote ends of the edge and the third element denotes the weight of that edge.</span></span><br><br><br></span></span></p>
<p>&nbsp;</p>
